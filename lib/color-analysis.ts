...
export const COLOR_REFERENCES = {
  freeChlorine: [
    ...
    { range: [3.0, 5.0], color: { r: 255, g: 220, b: 100 }, status: "ok" },
  ...
  totalChlorine: [
    ...
    { range: [3.0, 5.0], color: { r: 255, g: 180, b: 180 }, status: "ok" },
  ...
  totalHardness: [
    ...
    { range: [100, 150], color: { r: 180, g: 180, b: 240 }, status: "low" },
    { range: [150, 300], color: { r: 200, g: 160, b: 220 }, status: "ok" },
    { range: [300, 400], color: { r: 180, g: 140, b: 200 }, status: "ok" },
    { range: [400, 500], color: { r: 160, g: 120, b: 180 }, status: "high" },
    { range: [500, 1000], color: { r: 140, g: 100, b: 160 }, status: "high" },
  ],
  cyanuricAcid: [
